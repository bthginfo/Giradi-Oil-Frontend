...
export const MEDUSA_BACKEND_URL =
  import.meta.env.VITE_MEDUSA_BACKEND_URL || "https://giradi-backend-svzb.onrender.com";
...
/** PayPal Client ID for the JS SDK (set via VITE_PAYPAL_CLIENT_ID env var) */
export const PAYPAL_CLIENT_ID =
  import.meta.env.VITE_PAYPAL_CLIENT_ID || "";

/** DACH region ID – needed for correct pricing and payment providers */
export const DACH_REGION_ID = "reg_01KKHA75JHZFXG9S2D4R2567R5";
